...
public class Data {
    ...
    public Data(String id, String name, double data1, double data2, double data3, double data4, double data5, double data6, double data7, double data8, double data9) {
        this.id = id;
        this.name = name;
        this.data1 = data1;
        this.data2 = data2;
