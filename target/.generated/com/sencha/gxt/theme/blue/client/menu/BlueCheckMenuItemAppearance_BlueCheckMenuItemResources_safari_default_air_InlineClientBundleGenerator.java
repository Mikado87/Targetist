...
public class BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator implements com.sencha.gxt.theme.blue.client.menu.BlueCheckMenuItemAppearance.BlueCheckMenuItemResources {
  private static BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator _instance0 = new BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.blue.client.menu.BlueMenuItemAppearance.BlueMenuItemStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GCGCW0WDPSB{border-style:" + ("solid")  + ";border-width:" + ("1px")  + ";padding:" + ("0")  + " !important;height:" + ((BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getHeight() + "px")  + ";width:" + ((BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getSafeUri().asString() + "\") -" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getLeft() + "px -" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-color:" + ("#ebf3fd")  + ";background-repeat:") + (("repeat-x")  + ";background-position:" + ("right"+ " " +"bottom")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#aaccf6")  + ";padding:" + ("0")  + ";}.GCGCW0WDPSB a{color:" + ("#233d6d")  + ";}.GCGCW0WDATB{display:" + ("block")  + ";line-height:" + ("16px")  + ";outline-style:" + ("none")  + ";outline-width:" + ("0")  + ";padding:" + ("3px"+ " " +"27px"+ " " +"3px"+ " " +"21px")  + ";position:" + ("relative") ) + (";text-decoration:" + ("none")  + ";white-space:" + ("nowrap")  + ";}.GCGCW0WDDTB{white-space:" + ("nowrap")  + ";display:" + ("block")  + ";padding:" + ("1px")  + ";cursor:" + ("pointer")  + ";font:" + ("normal"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"sans-serif")  + ";}.GCGCW0WDCTB{border:" + ("0"+ " " +"none")  + ";height:" + ("16px")  + ";padding:" + ("0")  + ";vertical-align:") + (("top")  + ";width:" + ("16px")  + ";position:" + ("absolute")  + ";right:" + ("3px")  + ";top:" + ("3px")  + ";margin:" + ("0")  + ";background-position:" + ("center")  + ";}a.GCGCW0WDATB{color:" + ("#222")  + ";}.GCGCW0WDBTB{height:" + ((BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getHeight() + "px")  + ";width:" + ((BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getWidth() + "px")  + ";overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getSafeUri().asString() + "\") -" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getLeft() + "px -" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getTop() + "px  no-repeat")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";background-position:" + ("left")  + ";background-repeat:" + ("no-repeat")  + ";}")) : ((".GCGCW0WDPSB{border-style:" + ("solid")  + ";border-width:" + ("1px")  + ";padding:" + ("0")  + " !important;height:" + ((BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getHeight() + "px")  + ";width:" + ((BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getSafeUri().asString() + "\") -" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getLeft() + "px -" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.itemOver()).getTop() + "px  no-repeat")  + ";width:" + ("auto")  + ";height:" + ("auto")  + ";background-color:" + ("#ebf3fd")  + ";background-repeat:") + (("repeat-x")  + ";background-position:" + ("left"+ " " +"bottom")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#aaccf6")  + ";padding:" + ("0")  + ";}.GCGCW0WDPSB a{color:" + ("#233d6d")  + ";}.GCGCW0WDATB{display:" + ("block")  + ";line-height:" + ("16px")  + ";outline-style:" + ("none")  + ";outline-width:" + ("0")  + ";padding:" + ("3px"+ " " +"21px"+ " " +"3px"+ " " +"27px")  + ";position:" + ("relative") ) + (";text-decoration:" + ("none")  + ";white-space:" + ("nowrap")  + ";}.GCGCW0WDDTB{white-space:" + ("nowrap")  + ";display:" + ("block")  + ";padding:" + ("1px")  + ";cursor:" + ("pointer")  + ";font:" + ("normal"+ " " +"11px"+ " " +"tahoma"+ ","+ " " +"arial"+ ","+ " " +"sans-serif")  + ";}.GCGCW0WDCTB{border:" + ("0"+ " " +"none")  + ";height:" + ("16px")  + ";padding:" + ("0")  + ";vertical-align:") + (("top")  + ";width:" + ("16px")  + ";position:" + ("absolute")  + ";left:" + ("3px")  + ";top:" + ("3px")  + ";margin:" + ("0")  + ";background-position:" + ("center")  + ";}a.GCGCW0WDATB{color:" + ("#222")  + ";}.GCGCW0WDBTB{height:" + ((BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getHeight() + "px")  + ";width:" + ((BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getWidth() + "px")  + ";overflow:" + ("hidden") ) + (";background:" + ("url(\"" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getSafeUri().asString() + "\") -" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getLeft() + "px -" + (BlueCheckMenuItemAppearance_BlueCheckMenuItemResources_safari_default_air_InlineClientBundleGenerator.this.menuParent()).getTop() + "px  no-repeat")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";background-position:" + ("right")  + ";background-repeat:" + ("no-repeat")  + ";}"));
      }
