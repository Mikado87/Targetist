  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.blue.client.panel.BlueHeaderFramedAppearance.BlueHeaderFramedStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GCGCW0WDPVB{padding:" + ("4px"+ " " +"5px"+ " " +"2px"+ " " +"3px")  + ";position:" + ("relative")  + ";}.GCGCW0WDCWB{float:" + ("right")  + ";}.GCGCW0WDBWB .GCGCW0WDCWB{width:" + ("18px")  + ";}.GCGCW0WDBWB .GCGCW0WDDWB{right:" + ("20px")  + ";}.GCGCW0WDDWB{font-family:" + ("tahoma"+ ","+ " " +"arial"+ ","+ " " +"verdana"+ ","+ " " +"sans-serif")  + ";font-size:" + ("11px")  + ";font-weight:" + ("bold")  + ";line-height:" + ("15px")  + ";}.GCGCW0WDAWB{float:" + ("left")  + ";}.GCGCW0WDPVB{height:") + (((BlueHeaderFramedAppearance_BlueFramedHeaderResources_default_InlineClientBundleGenerator.this.headerBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueHeaderFramedAppearance_BlueFramedHeaderResources_default_InlineClientBundleGenerator.this.headerBackground()).getSafeUri().asString() + "\") -" + (BlueHeaderFramedAppearance_BlueFramedHeaderResources_default_InlineClientBundleGenerator.this.headerBackground()).getLeft() + "px -" + (BlueHeaderFramedAppearance_BlueFramedHeaderResources_default_InlineClientBundleGenerator.this.headerBackground()).getTop() + "px  repeat-x")  + ";color:" + ("#15428b")  + ";font-weight:" + ("bold")  + ";font-size:" + ("11px")  + ";font-family:" + ("tahoma"+ ","+ " " +"arial"+ ","+ " " +"verdana"+ ","+ " " +"sans-serif")  + ";border-color:" + ("#99bbe8")  + ";height:" + ("auto")  + ";line-height:" + ("15px")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#99bbe8") ) + (";border-top:" + ("none")  + ";border-right:" + ("none")  + ";border-left:" + ("none")  + ";border-bottom:" + ("none")  + ";padding-right:" + ("0")  + ";}")) : ((".GCGCW0WDPVB{padding:" + ("4px"+ " " +"3px"+ " " +"2px"+ " " +"5px")  + ";position:" + ("relative")  + ";}.GCGCW0WDCWB{float:" + ("left")  + ";}.GCGCW0WDBWB .GCGCW0WDCWB{width:" + ("18px")  + ";}.GCGCW0WDBWB .GCGCW0WDDWB{left:" + ("20px")  + ";}.GCGCW0WDDWB{font-family:" + ("tahoma"+ ","+ " " +"arial"+ ","+ " " +"verdana"+ ","+ " " +"sans-serif")  + ";font-size:" + ("11px")  + ";font-weight:" + ("bold")  + ";line-height:" + ("15px")  + ";}.GCGCW0WDAWB{float:" + ("right")  + ";}.GCGCW0WDPVB{height:") + (((BlueHeaderFramedAppearance_BlueFramedHeaderResources_default_InlineClientBundleGenerator.this.headerBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (BlueHeaderFramedAppearance_BlueFramedHeaderResources_default_InlineClientBundleGenerator.this.headerBackground()).getSafeUri().asString() + "\") -" + (BlueHeaderFramedAppearance_BlueFramedHeaderResources_default_InlineClientBundleGenerator.this.headerBackground()).getLeft() + "px -" + (BlueHeaderFramedAppearance_BlueFramedHeaderResources_default_InlineClientBundleGenerator.this.headerBackground()).getTop() + "px  repeat-x")  + ";color:" + ("#15428b")  + ";font-weight:" + ("bold")  + ";font-size:" + ("11px")  + ";font-family:" + ("tahoma"+ ","+ " " +"arial"+ ","+ " " +"verdana"+ ","+ " " +"sans-serif")  + ";border-color:" + ("#99bbe8")  + ";height:" + ("auto")  + ";line-height:" + ("15px")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#99bbe8") ) + (";border-top:" + ("none")  + ";border-left:" + ("none")  + ";border-right:" + ("none")  + ";border-bottom:" + ("none")  + ";padding-left:" + ("0")  + ";}"));
      }
